export const getTimeDisplay = (time) => {
    ...
    } else if (differenceTimeMinutes > 5 && differenceTimeMinutes <= 10) {
        return "10 минут назад";
    } else if (differenceTimeMinutes > 10 && differenceTimeMinutes <= 30) {
        return "30 минут назад";
    } else if (differenceTimeMinutes > 30 && differenceTimeMinutes / 60 <= 24) {
        return `${dateHours}:${dateMinutes}`;
    } else if (differenceTimeMinutes / 60 > 24 && differenceTimeMinutes / 60 / 24 <= 365) {
        return `${dateDay}.${dateMonth}`;
    } else if (differenceTimeMinutes / 60 / 24 > 365) {
